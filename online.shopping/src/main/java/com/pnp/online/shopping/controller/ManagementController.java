package com.pnp.online.shopping.controller;
...
import com.pnp.online.shopping.util.FileUtil;
import com.pnp.online.shopping.validator.ProductValidator;
...
public class ManagementController {
    ...
    public String managePostCategory(@ModelAttribute("category") catergory mCategory, HttpServletRequest request) {
        categoryDAO.add(mCategory);
        return "redirect:" + request.getHeader("Referer") + "?success=category";
    }

    @ModelAttribute("categories")
    public List<catergory> modelCategories() {
        return categoryDAO.list();
    }

    @ModelAttribute("category")
    public catergory modelCategory() {
